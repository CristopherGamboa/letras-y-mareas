...
export class ReviewService {
  ...
  /**
   * @description 
   * Devuelve una lista de reseñas
   * 
   * @returns {Review[]} Lista de reseñas
   */
  getReviews(): Review[] {
    return this.reviews;
  }
  ...
  /**
   * @description 
   * Devuelve una reseña por su id
   * 
   * @param {string} reviewId - id de la reseña
   * @returns {Review | undefined} regresa una reseña o undefined si no la encuentra
   */
  ...
  /**
   * @description 
   * Devuelve una lista de cartas de reseñas
   * 
   * @returns {Card[]} Lista de cartas de reseñas
   */
  getReviewCards(): Card[] {
